...
describe('GET /todos/:id', () => {
  it('Should return todo doc', (done) => {
    request(app)
      ...
      .set('x-auth', users[0].tokens[0].token) // pass in token of first user which is the owner of the first todo entered in previous line
      .expect(200)
      .expect((res) => {
...
describe('DELETE /todos/:id', () => {
  it('Should remove a todo', (done) => {
    ...
    it('Should not remove a todo because wrong users todo is passed', (done) => {
